...
public class Lang extends EngineLang {
    ...
    public static final LangKey EDITOR_PRODUCT_ENTER_UNI_PRICE = LangKey.of("Editor.Product.Enter.UniPrice", GRAY + "Enter " + GREEN + "[Min] [Max]");
