...
public class ChestLang implements LangColors {
    ...
    public static final LangKey SHOP_CREATION_INFO_DONE          = LangKey.of("ChestShop.Shop.Creation.Info.Done", "{message: ~type: TITLES; ~fadeIn: 10; ~stay: 80; ~fadeOut: 10; ~sound: BLOCK_NOTE_BLOCK_BELL;}&a&lShop Created!\n&7Use &aShift-Click &7to enter in &aEdit Mode&7.");
    ...
    public static final LangKey SHOP_REMOVAL_INFO_DONE        = LangKey.of("ChestShop.Shop.Removal.Info.Done", "{message: ~type: TITLES; ~fadeIn: 10; ~stay: 80; ~fadeOut: 10; ~sound: ENTITY_GENERIC_EXPLODE;}&c&lShop Removed.");
    ...
    public static final LangKey SHOP_TRADE_BUY_INFO_USER  = LangKey.of("ChestShop.Shop.Trade.Buy.Info.User", "{message: ~prefix: false;}&eYou bought &6x%amount% %item% &efor &6%price% &efrom &6%shop_name%&e shop owned by &6%shop_owner%&e.");
    public static final LangKey SHOP_TRADE_BUY_INFO_OWNER  = LangKey.of("ChestShop.Shop.Trade.Buy.Info.Owner", "{message: ~prefix: false;}&6%player% &ejust bought &6x%amount% %item% &efor &6%price% &efrom your &6%shop_name%&e shop.");
    public static final LangKey SHOP_TRADE_SELL_INFO_USER       = LangKey.of("ChestShop.Shop.Trade.Sell.Info.User", "{message: ~prefix: false;}&eYou sold &6x%amount% %item% &efor &6%price% &eto &6%shop_name%&e shop owned by &6%shop_owner%&e.");
    public static final LangKey SHOP_TRADE_SELL_INFO_OWNER       = LangKey.of("ChestShop.Shop.Trade.Sell.Info.Owner", "{message: ~prefix: false;}&6%player% &ejust sold &6x%amount% %item% &efor &6%price% &eto your &6%shop_name%&e shop.");
