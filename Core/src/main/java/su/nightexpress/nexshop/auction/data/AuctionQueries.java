...
public class AuctionQueries {
    ...
    public static final InsertQuery<ActiveListing> ACTIVE_LISTING_INSERT_QUERY = new InsertQuery<ActiveListing>()
        ...
        .setValue(AuctionDatabase.COLUMN_ITEM, listing -> String.valueOf(listing.getItemPacker().serialize()))
        .setValue(AuctionDatabase.COLUMN_HANDLER, listing -> listing.getItemHandler().getName())
