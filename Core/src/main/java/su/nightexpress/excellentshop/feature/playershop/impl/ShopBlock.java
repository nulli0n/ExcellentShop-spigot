...
public class ShopBlock implements Writeable {
    ...
    public ItemStack getItemStack() {
        ItemStack itemStack = this.getItem().replacement(replacer -> replacer.replace(ShopPlaceholders.GENERIC_TYPE, LangUtil.getSerializedName(this.material))).getItemStack();
