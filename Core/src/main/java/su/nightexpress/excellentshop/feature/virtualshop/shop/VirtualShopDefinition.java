...
public class VirtualShopDefinition implements Writeable {
    ...
    @NotNull
    public VirtualShopDefinition load(@NotNull FileConfig config, @NotNull String path) {
    ...
    public String getLayout(int page) {
        return this.paginatedLayouts && this.pageLayouts.containsKey(page) ? this.pageLayouts.get(page) : this.pageLayouts.computeIfAbsent(DEFAULT_LAYOUT_PAGE, k -> ShopPlaceholders.DEFAULT);
    }
