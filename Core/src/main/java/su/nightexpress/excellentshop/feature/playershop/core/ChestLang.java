...
public class ChestLang implements LangContainer {
    ...
    public static final MessageLocale PRODUCT_PURCHASE_BUY_SINGLE = LangEntry.builder("ChestShop.Product.Purchase.BuySingle").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
        GRAY.wrap("You bought " + WHITE.wrap(GENERIC_PRODUCTS) + " for " + GREEN.wrap(GENERIC_WORTH))
    );

    public static final MessageLocale PRODUCT_PURCHASE_BUY_MULTIPLE = LangEntry.builder("ChestShop.Product.Purchase.BuyMultiple").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
    ...
    public static final MessageLocale PRODUCT_PURCHASE_SELL_SINGLE = LangEntry.builder("ChestShop.Product.Purchase.SellSingle").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
        GRAY.wrap("You sold " + WHITE.wrap(GENERIC_PRODUCTS) + " for " + GREEN.wrap(GENERIC_WORTH))
    );

    public static final MessageLocale PRODUCT_PURCHASE_SELL_MULTIPLE = LangEntry.builder("ChestShop.Product.Purchase.SellMultiple").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
    ...
    public static final MessageLocale PURCHASE_NOTIFY_BUY_SINGLE = LangEntry.builder("ChestShop.Purchase.Notify.BuySingle").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
        GRAY.wrap(ORANGE.wrap(PLAYER_DISPLAY_NAME) + " bought " + WHITE.wrap(GENERIC_PRODUCTS) + " for " + GREEN.wrap(GENERIC_WORTH) + " from your " + WHITE.wrap(SHOP_NAME) + ".")
    );

    public static final MessageLocale PURCHASE_NOTIFY_SELL_SINGLE = LangEntry.builder("ChestShop.Purchase.Notify.SellSingle").chatMessage(
        Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
        GRAY.wrap(ORANGE.wrap(PLAYER_DISPLAY_NAME) + " sold " + WHITE.wrap(GENERIC_PRODUCTS) + " for " + GREEN.wrap(GENERIC_WORTH) + " to your " + WHITE.wrap(SHOP_NAME) + ".")
    );
...
//        GRAY.wrap("Enter " + GREEN.wrap("[Currency]")));
    ...
    public static final MessageLocale BANK_ERROR_NOT_EXIST = LangEntry.builder("ChestShop.Shop.Bank.Error.NotExist").chatMessage(
