...
public class VirtualPerms {
    ...
    public static final UniPermission MODULE  = new UniPermission(PREFIX + ShopPlaceholders.WILDCARD);
    public static final UniPermission SHOP    = new UniPermission(PREFIX_SHOP + ShopPlaceholders.WILDCARD);
    ...
    public static final UniPermission COMMAND_SELL_MENU_OTHERS     = new UniPermission(PREFIX_COMMAND +
        "sellmenu.others");
    public static final UniPermission COMMAND_SELL_ALL             = new UniPermission(PREFIX_COMMAND + "sellall");
    public static final UniPermission COMMAND_SELL_ALL_OTHERS      = new UniPermission(PREFIX_COMMAND +
        "sellall.others");
    public static final UniPermission COMMAND_SELL_HAND            = new UniPermission(PREFIX_COMMAND + "sellhand");
    public static final UniPermission COMMAND_SELL_HAND_OTHERS     = new UniPermission(PREFIX_COMMAND +
        "sellhand.others");
    public static final UniPermission COMMAND_SELL_HAND_ALL        = new UniPermission(PREFIX_COMMAND + "sellhandall");
    public static final UniPermission COMMAND_SELL_HAND_ALL_OTHERS = new UniPermission(PREFIX_COMMAND +
        "sellhandall.others");
