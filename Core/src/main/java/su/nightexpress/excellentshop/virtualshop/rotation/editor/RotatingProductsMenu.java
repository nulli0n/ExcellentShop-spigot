...
public class RotatingProductsMenu extends AbstractObjectMenu<VirtualShop> {
    ...
    private static final IconLocale LOCALE_CREATION = VirtualLang.iconBuilder(
        "UI.Editor.Shop.RotatingProducts.Creation")
    ...
    public RotatingProductsMenu(@NonNull ShopPlugin plugin, @NonNull VirtualShopModule module) {
