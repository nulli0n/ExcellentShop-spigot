package su.nightexpress.excellentshop.virtualshop;
...
public class VSDefaults {

    public static void createDefaultShops(@NonNull VirtualShopModule module) {
        createShop(module, "building_blocks",
            ...
            12,
            11,
            VSDefaults::addBuildingBlocksItems);
        ...
        createShop(module, "colored_blocks",
            ...
            11,
            12,
            VSDefaults::addColoredBlocksItems);
        ...
        createShop(module, "miscellaneous",
            ...
            2,
            15,
            VSDefaults::addMiscellaneousItems);
        ...
        createShop(module, "combat_tools",
            ...
            3,
            23,
            VSDefaults::addCombatToolsItems);
        ...
        createShop(module, "decoration",
            ...
            4,
            32,
            VSDefaults::addDecorationItems);
    }

    private static void addBuildingBlocksItems(@NonNull VirtualShop shop) {
    ...
    private static void addFarmingItems(@NonNull VirtualShop shop) {
    ...
    private static void addRedstoneItems(@NonNull VirtualShop shop) {
    ...
    private static void addFoodItems(@NonNull VirtualShop shop) {
    ...
    private static void addMobDropsItems(@NonNull VirtualShop shop) {
    ...
    private static void addMiscellaneousItems(@NonNull VirtualShop shop) {
    ...
    private static void addPotionsItems(@NonNull VirtualShop shop) {
        addShopProduct(shop, Material.POTION, PotionType.LONG_REGENERATION, 300, 1, 1);
        addShopProduct(shop, Material.POTION, PotionType.LONG_SWIFTNESS, 350, 1, 2);
        addShopProduct(shop, Material.POTION, PotionType.LONG_STRENGTH, 450, 1, 3);
        addShopProduct(shop, Material.POTION, PotionType.HEALING, 250, 1, 4);
        addShopProduct(shop, Material.POTION, PotionType.FIRE_RESISTANCE, 400, 1, 5);
        addShopProduct(shop, Material.POTION, PotionType.WATER_BREATHING, 200, 1, 6);
        addShopProduct(shop, Material.POTION, PotionType.LONG_LEAPING, 250, 1, 7);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_REGENERATION, 400, 1, 10);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_SWIFTNESS, 500, 1, 11);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_STRENGTH, 600, 1, 12);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_HEALING, 350, 1, 13);
        addShopProduct(shop, Material.POTION, PotionType.LONG_FIRE_RESISTANCE, 500, 1, 14);
        addShopProduct(shop, Material.POTION, PotionType.LONG_WATER_BREATHING, 300, 1, 15);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_LEAPING, 400, 1, 16);
        addShopProduct(shop, Material.POTION, PotionType.NIGHT_VISION, 250, 1, 19);
        addShopProduct(shop, Material.POTION, PotionType.INVISIBILITY, 250, 1, 20);
        addShopProduct(shop, Material.POTION, PotionType.HARMING, 300, 1, 21);
        addShopProduct(shop, Material.POTION, PotionType.SLOW_FALLING, 250, 1, 22);
        addShopProduct(shop, Material.POTION, PotionType.LONG_POISON, 250, 1, 23);
        addShopProduct(shop, Material.POTION, PotionType.SLOWNESS, 150, 1, 24);
        addShopProduct(shop, Material.POTION, PotionType.WEAKNESS, 150, 1, 25);
        addShopProduct(shop, Material.POTION, PotionType.LONG_NIGHT_VISION, 400, 1, 28);
        addShopProduct(shop, Material.POTION, PotionType.LONG_INVISIBILITY, 400, 1, 29);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_HARMING, 400, 1, 30);
        addShopProduct(shop, Material.POTION, PotionType.LONG_SLOW_FALLING, 350, 1, 31);
        addShopProduct(shop, Material.POTION, PotionType.STRONG_POISON, 400, 1, 32);
        addShopProduct(shop, Material.POTION, PotionType.LONG_SLOWNESS, 250, 1, 33);
        addShopProduct(shop, Material.POTION, PotionType.LONG_WEAKNESS, 250, 1, 34);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_REGENERATION, 300, 2, 1);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_SWIFTNESS, 350, 2, 2);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_STRENGTH, 450, 2, 3);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.HEALING, 250, 2, 4);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.FIRE_RESISTANCE, 400, 2, 5);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.WATER_BREATHING, 200, 2, 6);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_LEAPING, 250, 2, 7);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_REGENERATION, 400, 2, 10);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_SWIFTNESS, 500, 2, 11);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_STRENGTH, 650, 2, 12);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_HEALING, 350, 2, 13);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_FIRE_RESISTANCE, 500, 2, 14);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_WATER_BREATHING, 300, 2, 15);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_LEAPING, 400, 2, 16);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.NIGHT_VISION, 250, 2, 19);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.INVISIBILITY, 250, 2, 20);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.HARMING, 300, 2, 21);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.SLOW_FALLING, 250, 2, 22);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_POISON, 250, 2, 23);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.SLOWNESS, 150, 2, 24);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.WEAKNESS, 150, 2, 25);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_NIGHT_VISION, 400, 2, 28);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_INVISIBILITY, 400, 2, 29);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_HARMING, 400, 2, 30);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_SLOW_FALLING, 350, 2, 31);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.STRONG_POISON, 400, 2, 32);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_SLOWNESS, 250, 2, 33);
        addShopProduct(shop, Material.SPLASH_POTION, PotionType.LONG_WEAKNESS, 250, 2, 34);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_REGENERATION, 200, 3, 1);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_SWIFTNESS, 200, 3, 2);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_STRENGTH, 250, 3, 3);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.HEALING, 200, 3, 4);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.FIRE_RESISTANCE, 200, 3, 5);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.WATER_BREATHING, 100, 3, 6);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_LEAPING, 200, 3, 7);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_REGENERATION, 300, 3, 10);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_SWIFTNESS, 300, 3, 11);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_STRENGTH, 300, 3, 12);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_HEALING, 300, 3, 13);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_FIRE_RESISTANCE, 300, 3, 14);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_WATER_BREATHING, 150, 3, 15);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_LEAPING, 300, 3, 16);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.NIGHT_VISION, 150, 3, 19);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.INVISIBILITY, 150, 3, 20);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.HARMING, 200, 3, 21);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.SLOW_FALLING, 200, 3, 22);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_POISON, 150, 3, 23);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.SLOWNESS, 100, 3, 24);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.WEAKNESS, 100, 3, 25);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_NIGHT_VISION, 200, 3, 28);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_INVISIBILITY, 200, 3, 29);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_HARMING, 300, 3, 30);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_SLOW_FALLING, 300, 3, 31);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.STRONG_POISON, 300, 3, 32);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_SLOWNESS, 250, 3, 33);
        addShopProduct(shop, Material.LINGERING_POTION, PotionType.LONG_WEAKNESS, 250, 3, 34);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_REGENERATION, 350, 4, 1);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_SWIFTNESS, 400, 4, 2);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_STRENGTH, 500, 4, 3);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.HEALING, 350, 4, 4);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.FIRE_RESISTANCE, 350, 4, 5);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.WATER_BREATHING, 250, 4, 6);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_LEAPING, 250, 4, 7);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_REGENERATION, 450, 4, 10);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_SWIFTNESS, 600, 4, 11);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_STRENGTH, 700, 4, 12);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_HEALING, 500, 4, 13);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_FIRE_RESISTANCE, 500, 4, 14);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_WATER_BREATHING, 400, 4, 15);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_LEAPING, 350, 4, 16);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.NIGHT_VISION, 250, 4, 19);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.INVISIBILITY, 400, 4, 20);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.HARMING, 500, 4, 21);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.SLOW_FALLING, 350, 4, 22);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_POISON, 400, 4, 23);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.SLOWNESS, 250, 4, 24);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.WEAKNESS, 250, 4, 25);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_NIGHT_VISION, 350, 4, 28);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_INVISIBILITY, 650, 4, 29);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_HARMING, 700, 4, 30);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_SLOW_FALLING, 500, 4, 31);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.STRONG_POISON, 500, 4, 32);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_SLOWNESS, 400, 4, 33);
        addShopProduct(shop, Material.TIPPED_ARROW, PotionType.LONG_WEAKNESS, 400, 4, 34);
    }

    private static void addDecorationItems(@NonNull VirtualShop shop) {
        ...
        if (Version.isAtLeast(Version.MC_1_21_11)) {
            addShopProduct(shop, Material.IRON_CHAIN, 85, 1, 4, 26);
        }
    ...
    private static void addMineralsItems(@NonNull VirtualShop shop) {
    ...
    private static void addCombatToolsItems(@NonNull VirtualShop shop) {
    ...
    private static void addColoredBlocksItems(@NonNull VirtualShop shop) {
    ...
    private static void createShop(@NonNull VirtualShopModule module,
                                   @NonNull String id,
                                   ...
                                   int pages,
                                   int menuSlot,
                                   @NonNull Consumer<VirtualShop> consumer) {
    ...
    private static void addShopProduct(@NonNull VirtualShop shop, @NonNull Material material, double buyPrice,
                                       double sellPrice, int page, int slot) {
        addShopProduct(shop, new ItemStack(material), buyPrice, sellPrice, page, slot);
    }

    private static void addShopProduct(@NonNull VirtualShop shop, @NonNull Material material, @NonNull PotionType type,
                                       double buyPrice, int page, int slot) {
        ItemStack itemStack = new ItemStack(material);
        ItemUtil.editMeta(itemStack, PotionMeta.class, potionMeta -> {
            potionMeta.setBasePotionType(type);
        });

        addShopProduct(shop, itemStack, buyPrice, -1, page, slot);
    }

    private static void addShopProduct(@NonNull VirtualShop shop, @NonNull ItemStack itemStack, double buyPrice,
                                       double sellPrice, int page, int slot) {
    ...
    private static void addShopProduct(@NonNull VirtualShop shop, @NonNull ItemStack itemStack,
                                       @NonNull Consumer<VirtualProduct> consumer) {
