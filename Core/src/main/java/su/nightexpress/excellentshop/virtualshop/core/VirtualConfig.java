...
public class VirtualConfig {
    ...
    public static final ConfigValue<Boolean> MAIN_MENU_HIDE_NO_PERM_SHOPS = ConfigValue.create(
        "General.Main_Menu.Hide_No_Permission_Shops",
        true,
        "When enabled, hides shops from the main menu a player don't have access to."
    );

    public static final ConfigValue<Boolean> SHOP_SHORTCUTS_ENABLED = ConfigValue.create(
        "General.Shop_Shortcut.Enabled",
        true,
        "Enables the Shop Shortcut and Shop Aliases commands features. Allows to quickly open shops."
    );

    public static final ConfigValue<String[]> SHOP_SHORTCUTS_COMMANDS = ConfigValue.create(
        "General.Shop_Shortcut.Commands",
    ...
    public static final ConfigValue<String[]> SELL_HAND_ALL_COMMANDS = ConfigValue.create(
        "General.Sell_Hand_All.Commands",
        new String[]{"sellhandall"},
        "Sell Hand All command aliases. Split with commas."
    );

    public static final ConfigValue<RankMap<Double>> SELL_RANK_MULTIPLIERS = ConfigValue.create(
        "General.Sell_Multipliers",
        ...
        "If you want to use permission based system, you can use '" + VirtualPerms.PREFIX_SELL_MULTIPLIER +
    ...
    public static final ConfigValue<Set<GameMode>> DISABLED_GAMEMODES = ConfigValue.forSet(
        "General.Disabled_In_Gamemodes",
