...
import static su.nightexpress.excellentshop.ShopPlaceholders.GENERIC_BALANCE;
import static su.nightexpress.excellentshop.ShopPlaceholders.GENERIC_SELL_MULTIPLIER;
...
public class CentralMenu extends NormalMenu<ShopPlugin> implements ConfigBased {
    ...
    public CentralMenu(@NonNull ShopPlugin plugin, @NonNull VirtualShopModule module) {
    ...
    protected void onItemPrepare(@NonNull MenuViewer viewer, @NonNull MenuItem menuItem, @NonNull NightItem item) {
        ...
        item.replacement(replacer -> replacer
            .replace(GENERIC_BALANCE, () -> currency.format(currency.queryBalance(viewer.getPlayer())))
            .replace(GENERIC_SELL_MULTIPLIER, () -> NumberUtil.format(VirtualShopModule.getSellMultiplier(viewer
                .getPlayer())))
        ...
        this.module.getShops().forEach(shop -> {
            ...
            this.addItem(viewer, shop.getIcon()
                ...
                .setHandler(ItemHandler.forClick((viewer1, event) -> {
                    ...
                    return !VirtualConfig.MAIN_MENU_HIDE_NO_PERM_SHOPS.get() || shop.canAccess(viewer1.getPlayer(),
                        false);
                }).build()))
            );
        });
    ...
    public void loadConfiguration(@NonNull FileConfig config, @NonNull MenuLoader loader) {
        loader.addDefaultItem(NightItem.fromType(Material.GRAY_STAINED_GLASS_PANE).setHideTooltip(true).toMenuItem()
            .setSlots(IntStream.range(0, 54).toArray()));
        ...
        loader.addDefaultItem(NightItem.asCustomHead("9fd108383dfa5b02e86635609541520e4e158952d68c1c8f8f200ec7e88642d")
            ...
            .setLore(Lists.newList(
                ...
                "",
                LIGHT_GRAY.wrap(HEX_COLOR.wrap("➥", "#ebd12a") + " Sell Multiplier: " + HEX_COLOR.wrap("x" +
                    GENERIC_SELL_MULTIPLIER, "#ebd12a")),
                "",
            ...
            .toMenuItem().setSlots(43).setPriority(10).setHandler(new ItemHandler("sell_all", (viewer, event) -> {
                ...
                this.module.sellAll(player, completed -> {
                });
            }))
        );
    }
