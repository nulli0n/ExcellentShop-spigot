...
public class RotationTimesMenu extends LinkedMenu<ShopPlugin, Rotation> implements Filled<DayOfWeek> {
    ...
    private static final String[] SKULL_DAY = {"a8432a5756a04ebf062d72a6f31bd62e8f4d82a92120336ae1972fe18d3870ba", "7e50c7097994313d9432142da7651dc6dd633587e2e1dd9a562abbc7878efb65", "5dd22db8c6e238fb8cc0819d02a65403297d63b67c6c7ce6b43bc829189837f4", "854c1ded92319bd83573f0f0041e730338eb7bb7997eb71ff583c2908323888e", "54dac7cf2017a2aefcdf29dc3832d407cbd9c8b6ba0e51a0a3169f6ffb62c015", "ded9bedcc1d1c48caee5728e1ef9b008d5a5d30d2e14c1c7b849e8d8553b5257", "90bba8d56bb6b906683b18fba481d58fa0bb7d3b3b18c6452e9257df542f53aa"
    };

    //private final VirtualShopModule module;

    public RotationTimesMenu(@NonNull ShopPlugin plugin, @NonNull VirtualShopModule module) {
    ...
    @Override
    @NonNull
    public MenuFiller<DayOfWeek> createFiller(@NonNull MenuViewer viewer) {
            ...
            .setItemCreator(day -> {
                return NightItem.asCustomHead(SKULL_DAY[day.ordinal()])
                    ...
                    .replacement(replacer -> replacer
                        .replace(ShopPlaceholders.GENERIC_NAME, () -> StringUtil.capitalizeFully(day.name()))
                        .replace(ShopPlaceholders.GENERIC_TIME, () -> rotation.getRotationTimes(day).stream()
                            .map(time -> CoreLang.goodEntry(time.format(ShopUtils.TIME_FORMATTER))).collect(Collectors
                                .joining("\n")))
                    );
            })
            .setItemClick(day -> (viewer1, event) -> {
                if (event.isLeftClick()) {
                    this.handleInput(Dialog.builder(viewer, Lang.EDITOR_GENERIC_ENTER_TIME.text(), input -> {
                        try {
                            rotation.getRotationTimes(day).add(LocalTime.parse(input.getTextRaw(),
                                ShopUtils.TIME_FORMATTER));
