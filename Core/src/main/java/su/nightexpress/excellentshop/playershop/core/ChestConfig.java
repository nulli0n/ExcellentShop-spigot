...
public class ChestConfig {
    ...
    public static final ConfigValue<Boolean> SHOP_INFINITE_STORAGE_ENABLED = ConfigValue.create(
        "Shops.InfiniteStorage.Enabled",
        false,
    ...
    public static final ConfigValue<Double> SHOP_PRODUCT_INITIAL_BUY_PRICE = ConfigValue.create(
        "Shops.Product.InitialPrice.Buy",
        10D,
        "Sets initial buy price for new products added in chest shops.");

    public static final ConfigValue<Double> SHOP_PRODUCT_INITIAL_SELL_PRICE = ConfigValue.create(
        "Shops.Product.InitialPrice.Sell",
        2D,
        "Sets initial sell price for new products added in chest shops.");

    public static final ConfigValue<Boolean> SHOP_ITEM_CREATION_ENABLED = ConfigValue.create(
        "Shops.ItemCreation.Enabled",
        false,
    ...
    public static final ConfigValue<Set<String>> SHOP_CREATION_WORLD_BLACKLIST = ConfigValue.create(
        "Shops.Creation.World_Blacklist",
        Set.of("custom_world", "another_world"),
        "List of worlds, where chest shop creation is not allowed.");

    public static final ConfigValue<RankMap<Integer>> SHOP_CREATION_MAX_PER_RANK = ConfigValue.create(
        "Shops.Creation.Max_Shops_Per_Rank",
        (cfg, path, rank) -> RankMap.read(cfg, path, Integer.class, 10),
        (cfg, path, map) -> map.write(cfg, path),
        () -> new RankMap<>(
            RankMap.Mode.RANK, ChestPerms.PREFIX_SHOP_LIMIT, 10, Map.of(
                "vip", 20,
                "admin", -1
            )
        ),
    ...
    public static final ConfigValue<Boolean> SHOP_CREATION_CHECK_BUILD = ConfigValue.create(
        "Shops.Creation.Check_Build_Access",
        true,
    ...
    public static final ConfigValue<Boolean> SHOP_CREATION_CLAIM_ONLY = ConfigValue.create(
        "Shops.Creation.In_Player_Claims_Only.Enabled",
        false,
    ...
    public final static ConfigValue<RankMap<Integer>> SHOP_PRODUCTS_MAX_PER_RANK = ConfigValue.create(
        "Shops.Products.Max_Products_Per_Shop",
        (cfg, path, rank) -> RankMap.read(cfg, path, Integer.class, 3),
        (cfg, path, map) -> map.write(cfg, path),
        () -> new RankMap<>(
            RankMap.Mode.RANK, ChestPerms.PREFIX_PRODUCT_LIMIT, 3, Map.of(
                "vip", 5,
                "admin", -1
            )
        ),
    ...
    public static final ConfigValue<Boolean> SHOP_PRODUCT_NEW_PRODUCTS_SINGLE_AMOUNT = ConfigValue.create(
        "Shops.Products.New_Products_Single_Amount",
        false,
    ...
    public static final ConfigValue<Set<String>> SHOP_PRODUCT_BANNED_ITEMS = ConfigValue.create(
        "Shops.Products.Material_Blacklist",
        Set.of(
    ...
    public static final ConfigValue<Set<String>> SHOP_PRODUCT_DENIED_LORES = ConfigValue.create(
        "Shops.Products.Lore_Blacklist",
    ...
    public static final ConfigValue<Set<String>> SHOP_PRODUCT_DENIED_NAMES = ConfigValue.create(
        "Shops.Products.Name_Blacklist",
    ...
    public static final ConfigValue<Map<String, Showcase>> SHOWCASE_CATALOG = ConfigValue.forMapById(
        "Display.Showcase.Catalog",
        Showcase::read,
