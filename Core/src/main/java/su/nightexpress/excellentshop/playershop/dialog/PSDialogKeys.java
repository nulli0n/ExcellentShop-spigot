package su.nightexpress.excellentshop.playershop.dialog;
...
public class PSDialogKeys {
    ...
    private PSDialogKeys() {
    }

    public static final DialogKey<ProductClickContext> PRODUCT_PURCHASE_OPTIONS = new DialogKey<>("pshop_product_purchase_options");

    public static final DialogKey<ChestShop> SHOP_ADD_TRUSTED_PLAYER = new DialogKey<>("pshop_add_trusted_player");
