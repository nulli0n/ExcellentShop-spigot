package su.nightexpress.excellentshop.playershop.repository;
...
public class WorldLookup {
    ...
    public Set<ChestShop> getAllIn(@NonNull Cuboid cuboid) {
        return this.byBlockPos.values().stream().filter(shop -> cuboid.contains(shop.getBlockPos())).collect(Collectors
