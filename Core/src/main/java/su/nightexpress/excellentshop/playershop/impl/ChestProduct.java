...
public class ChestProduct extends AbstractProduct<ChestShop> {
    ...
    @NonNull
    public static ChestProduct load(@NonNull FileConfig config, @NonNull String path, @NonNull UUID id,
                                    @NonNull ChestShop shop) throws ProductLoadException {
        ...
        product.setPricing(PriceFactory.read(config, path + ".Price"));
