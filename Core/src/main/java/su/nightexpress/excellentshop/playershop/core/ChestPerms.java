...
public class ChestPerms {
    ...
    public static final UniPermission DISABLE_BUYING  = new UniPermission(PREFIX +
        "disable.buying", PermissionDefault.TRUE);
    public static final UniPermission DISABLE_SELLING = new UniPermission(PREFIX +
        "disable.selling", PermissionDefault.TRUE);
