...
public class ModuleLoader {
    ...
    public ModuleLoader(@NonNull ShopPlugin plugin, @NonNull ModuleRegistry moduleRegistry) {
        this.plugin = plugin;
    ...
    public <T extends Module> void register(@NonNull String id, @NonNull ModuleDefinition definition,
                                            @NonNull ModuleFactory<T> factory) {
    ...
    public void loadAll() {
        ...
        this.definitionMap.forEach((id, defaultDefinition) -> {
            ...
            try {
                ...
                this.plugin.error("Fatal error when trying to load module '%s': %s".formatted(id, exception
                    .getMessage()));
            }
        });
    ...
    private boolean loadModule(@NonNull String id, @NonNull ModuleDefinition definition) throws ModuleLoadException {
