...
public abstract class AbstractShopModule extends AbstractModule implements ShopModule {
    ...
    @NonNull
    protected abstract CompletableFuture<@NonNull Boolean> handleSuccessfulTransaction(@NonNull ECompletedTransaction transaction);
    ...
    @NonNull
    private CompletableFuture<@NonNull Boolean> checkTransactionAffordance(@NonNull EPreparedTransaction transaction) {
