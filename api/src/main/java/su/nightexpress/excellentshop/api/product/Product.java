...
public interface Product extends PlaceholderResolvable {
    ...
    /**
     * Performs a check to determine if product is available for buying/selling (e.g. present in the shop, is in
     * rotation).
     * 
    ...
    @NonNull
    LimitData getLimitData(@NonNull Player player);
