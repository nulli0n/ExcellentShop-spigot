...
public class UserProductLimit {
    ...
    public UserProductLimit(@NotNull IShopVirtualProductPrepared product, @NotNull TradeType tradeType) {
        this(tradeType, product.getShop().getId(), product.getShopProduct().getId(), 0, 0L);
    ...
    public void update() {
        ...
        IShopVirtualProduct product = (IShopVirtualProduct) shop.getProductById(this.getProductId());
